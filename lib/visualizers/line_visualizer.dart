...
//
//   LineVisualizer({@required this.waveData, @required this.color, this.strokeWidth = 0.005})
//       : wavePaint = new Paint()
...
//       }
//       wavePaint.strokeWidth = size.height*strokeWidth;
//       wavePaint.style = PaintingStyle.stroke;
//
//       rect = new Rect.fromLTWH(0, 0, size.width, size.height/ 3);
